...
//Clean-Up
 ...
 useEffect(() => {
  let ctx = gsap.context(() => {
    //INSIDE CONTEXT >
       gsap.fromTo(textRef.current, {height: '0%',  opacity: 0}, {height: '100%', opacity: 1,  duration: 0.5, delay: 1})
      }, '.home-wrapper')
...
//Clean-Up
 ...
 useEffect(() => {
  let ctx = gsap.context(() => {
    //INSIDE CONTEXT >
       gsap.fromTo(scrollDownText.current, {y: -200, opacity: 0}, {y: 0, opacity: 1, duration: 1, delay: 1.25})
      }, '.home-wrapper')
    ...
    return (
        <div className='home-wrapper'>
          <Header ideRef={ideRef} textRef={textRef} specialRef={specialRef} scrollDownText={scrollDownText}  />
        </div>
    )
}
